...
module.exports = {
   ...
   * @param {function} errorCallback - Result on failure
   */
  printFormattedTextAndOpenCashBox: function(data, successCallback, errorCallback) {
    cordova.exec(successCallback, errorCallback, 'ThermalPrinter', 'printFormattedTextAndOpenCashBox', [data]);
  },
